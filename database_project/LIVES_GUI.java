...
public class LIVES_GUI extends javax.swing.JFrame {
    ...
    private void addressearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addressearchActionPerformed
        try {
            Connection conn = (Connection) database_project.Connection_DB.DBCon();
            java.sql.Statement stm = conn.createStatement();
    ...
    }//GEN-LAST:event_addressearchActionPerformed
