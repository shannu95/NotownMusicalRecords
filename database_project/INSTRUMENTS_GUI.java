...
public class INSTRUMENTS_GUI extends javax.swing.JFrame {
    ...
    private void instridsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instridsearchActionPerformed
         try {
            Connection conn = (Connection) database_project.Connection_DB.DBCon();
            java.sql.Statement stm = conn.createStatement();
    ...
    }//GEN-LAST:event_instridsearchActionPerformed

    private void dnamesearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dnamesearchActionPerformed
        try {
            Connection conn = (Connection) database_project.Connection_DB.DBCon();
            java.sql.Statement stm = conn.createStatement();
    ...
    }//GEN-LAST:event_dnamesearchActionPerformed
